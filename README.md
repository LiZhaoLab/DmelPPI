...
<small><b>Figure 1.</b> Scheme of interface analysis.<br> We check interface pairs by scanning clustered interfaces. <br>
In this example, there are three interfaces (1, 2, and 3). <br> 
For each interface, we examine whether an IDR is involved, <br> 
and if so, whether it represents coil binding, coil-to-order <br>
transition binding, or CF binding.
</p>
